...
def MILP(cp, deliveries, theta, reward, C, D, E, C1, S, tau_start, tau_end, nS, EVs, gamma_DD, psi_DD, gamma_DC, psi_DC, beta_f, rateE, rateC, alpha1, alpha2):
    ...
    # Your credentials are private and should not be shared or copied to public repositories.
    # Visit https://license.gurobi.com/manager/doc/overview for more information.
    # "WLSACCESSID" : "cb013bcc-bf64-4723-9403-e2ed08b30aad",
    # "WLSSECRET" : "3e1cc4cb-1046-4479-82ca-3455eea088ae",
    # "LICENSEID" : 2633407
    
    # Gurobi WLS license file
    # Your credentials are private and should not be shared or copied to public repositories.
    # Visit https://license.gurobi.com/manager/doc/overview for more information.
    "WLSACCESSID" : "c24ca5e5-a469-4f50-8143-83446043542b",
    "WLSSECRET" : "726784e2-fe5e-474d-b517-e34f16e94c28",
    "LICENSEID" : 2633407
    }
