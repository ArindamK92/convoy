...
#
# Flow:
# 1) Pretrain + save m_VRPTW checkpoint (POMO + beam-search).
# 2) Pretrain + save convoy_rl_partial_ch2 checkpoint (POMO + beam-search).
...
RL_CHECKPOINT_DIR="${RL_CHECKPOINT_DIR:-checkpoints_vrptw/rl_partial_ch2_c50_cp10_ev10_e100_pomo}"
...
echo
echo "=== Step 1: Pretrain + save m_VRPTW checkpoint (POMO + beam-search) ==="
...
echo
echo "=== Step 2: Pretrain + save convoy_rl_partial_ch2 checkpoint (POMO + beam-search) ==="
