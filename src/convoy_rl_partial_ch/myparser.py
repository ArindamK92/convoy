...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            "REINFORCE baseline type. "
            "For --rl-algo pomo, baseline must be 'shared'."
        ),
    )
    parser.add_argument(
        "--pomo-num-starts",
        ...
        default=0,
        help=(
            "POMO starts per instance. "
            "Use 0 to let RL4CO choose automatically."
        ),
    )
    parser.add_argument(
        "--pomo-num-augment",
        ...
        default=8,
        help=(
            "POMO state augmentation count. "
            "Set 1 to disable augmentation."
        ),
    )
    parser.add_argument(
        "--accelerator",
    ...
    parser.add_argument(
        ...
        help="Decoder strategy used for fixed-eval/test/printed solution.",
    )
    parser.add_argument(
        "--decode-num-samples",
        type=int,
        default=1,
        help="Number of sampled rollouts when decode-type uses sampling.",
    )
    parser.add_argument(
        "--decode-num-starts",
        type=int,
        default=0,
        help="Number of starts for multistart decode modes.",
    )
    parser.add_argument(
        "--decode-select-best",
        action="store_true",
        help="Select best rollout among sampled/multistart candidates.",
    )
    parser.add_argument(
        "--decode-temperature",
        type=float,
        default=1.0,
        help="Sampling temperature for decoder (higher = more exploration).",
    )
    parser.add_argument(
        "--decode-top-p",
        type=float,
        default=0.0,
        help="Top-p nucleus sampling threshold (0 disables).",
    )
    parser.add_argument(
        "--decode-top-k",
        type=int,
        default=0,
        help="Top-k sampling truncation (0 disables).",
    )
    parser.add_argument(
        "--decode-beam-width",
        type=int,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "If set, persist best checkpoint and reuse it in later runs. "
            "File name is best_model.ckpt for --rl-algo am and "
